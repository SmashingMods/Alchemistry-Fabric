...
Place `Alchemistry-1.0.4+mc26.2.jar`, the matching ChemLib JAR and Fabric API in your Fabric 26.2 instance's `mods` folder. Energy API and Forge Config API Port are bundled in Alchemistry. To use REI, install its matching Fabric release and its required dependencies.
