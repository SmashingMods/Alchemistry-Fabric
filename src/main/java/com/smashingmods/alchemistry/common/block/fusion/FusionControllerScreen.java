...
public class FusionControllerScreen extends AbstractAlchemistryScreen<FusionControllerScreenHandler> {
    ...
    private static final Identifier TEXTURE = new Identifier(Alchemistry.MOD_ID, "textures/gui/fusion_gui.png");

    protected final List<DisplayData> displayData = new ArrayList<>();

    public FusionControllerScreen(FusionControllerScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawForeground(MatrixStack matrices, int mouseX, int mouseY) {
        MutableText title = Text.translatable("alchemistry.container.fusion_controller");
