...
import com.smashingmods.alchemistry.common.block.fission.FissionScreenHandler;
...
public class ScreenRegistry {
    ...
    public static ExtendedScreenHandlerType<FissionScreenHandler> FISSION_SCREEN_HANDLER = new ExtendedScreenHandlerType<>(FissionScreenHandler::new);
