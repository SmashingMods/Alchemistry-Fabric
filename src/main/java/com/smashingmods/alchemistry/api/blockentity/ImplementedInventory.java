...
public interface ImplementedInventory extends WorldlyContainer {
    ...
    default boolean stillValid(Player player) {
        if (this instanceof net.minecraft.world.level.block.entity.BlockEntity entity) {
            return entity.getLevel() != null && entity.getLevel().getBlockEntity(entity.getBlockPos()) == entity
                && player.distanceToSqr(net.minecraft.world.phys.Vec3.atCenterOf(entity.getBlockPos())) <= 64;
        }
        return true;
    }
}
